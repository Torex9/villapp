  ...
  return (
    <ButtonSkeleton
      ...
      className={clsx(
        ...
        color === 'alpha' && 'bg-alpha text-white ring-alpha hover:bg-alpha-dark-200',
        color === 'error' && 'bg-error text-white ring-error hover:bg-error-dark',
        color === 'success' && 'bg-success text-white ring-success hover:bg-success-dark',
        color === 'disabled' && 'cursor-not-allowed bg-gray-200 text-inherit ring-gray-200',
        borderRadius,
        props.className
      )}
      ...
      size={props.size}
    >
      {IconStart !== null && <IconStart className={iconClassName} strokeWidth={1.5} />}
      {props.children}
      {IconEnd !== null && <IconEnd className={iconClassName} strokeWidth={1.5} />}
    </ButtonSkeleton>
  );
};
